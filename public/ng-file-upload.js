...
ngFileUpload.service("Upload", [
  ...
  function($parse, $timeout, $compile, $q, UploadExif) {
    ...
    upload.getAttrWithDefaults = function(attr, name) {
      ...
      return def == null
        ? def
        : angular.isString(def) ? def : JSON.stringify(def);
    };
          ...
          if (
            ...
            if (attribute.name === "id") {
              ...
              fileElem.attr(
                attribute.name,
                !attribute.value &&
                (attribute.name === "required" || attribute.name === "multiple")
                  ? attribute.name
                  : attribute.value
              );
            }
  ...
  ngFileUpload.filter("ngfDataUrl", [
    ...
    function(UploadDataUrl, $sce) {
      return function(file, disallowObjectUrl, trustedUrl) {
        ...
        return (
          (file && src
            ? trustedUrl ? $sce.trustAsResourceUrl(src) : src
            : file) || ""
        );
      };
    }
...
ngFileUpload.service("UploadValidate", [
  ...
  function(UploadDataUrl, $q, $timeout) {
    ...
    upload.validate = function(files, prevLength, ngModel, attr, scope) {
      ...
      var ignoredErrors = (upload.attrGetter("ngfIgnoreInvalid", attr, scope) ||
        ""
      ).split(" ");
